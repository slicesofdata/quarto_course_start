...
# these options work
# for data frame with numeric var
## overall
#descriptives(HT, var = Mark)
## with groups
#descriptives(HT, groupby = c(Season, Team), var = Mark)
# for data frame with char var
## overall
#descriptives(HT, var = Team)
## with groups
#descriptives(HT, groupby = c(Season, Team), var = Team)
